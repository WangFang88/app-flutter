            ...
            SliverToBoxAdapter(
              child: Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('公共提醒', style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontWeight: FontWeight.bold)),
                  Text('此刻 · ${_items.length} 个提醒', style: Theme.of(context).textTheme.bodyMedium?.copyWith(color: Colors.grey)),
                ]),
              ),
            ),
            if (_items.isEmpty)
